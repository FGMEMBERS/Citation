...
var citation_array_radios = [
  ...
  "/instrumentation/dme[0]/switch-position",
  "/instrumentation/dme[0]/switch-position[1]",
  "/instrumentation/dme[0]/dim",
  "/instrumentation/dme[0]/frequencies/source",
  "/instrumentation/dme[0]/frequencies/selected-mhz",
  "/instrumentation/dme[1]/switch-position",
  "/instrumentation/dme[1]/switch-position[1]",
  "/instrumentation/dme[1]/dim",
  "/instrumentation/dme[1]/frequencies/source",
  "/instrumentation/dme[1]/frequencies/selected-mhz",
  "/instrumentation/hsi[0]/inputs/heading-filtered-deg",
  "/instrumentation/hsi[1]/inputs/heading-filtered-deg",
  "/instrumentation/rmi/single-needle/position-deg",
  "/instrumentation/rmi/single-needle/selected-input",
  "/instrumentation/rmi/double-needle/position-deg",
  "/instrumentation/rmi/double-needle/selected-input",
